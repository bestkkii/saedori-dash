...
def create_news_detail_row(company, title, lead, url):
    ...
    return dmc.Grid([
            ...
            dmc.GridCol(dmc.Anchor(title, fw=500, fz="h4", ta="left", style=style_title, href=url, target="_blank", className="font"),span=11, style=style2),
            # dmc.GridCol(dmc.Text(lead, fw=500, fz="h5", ta="left", style=style_lead, className="font"), span=1, style=style2),
