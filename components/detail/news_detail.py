...
def create_news_detail_row(company, title, lead, url):
    ...
    return dmc.Grid([
            ...
            dmc.GridCol(dmc.Anchor(title, fw=500, fz="h4", ta="left", style=style_title, href=url, target="_blank"),span=10, style=style2),
            dmc.GridCol(dmc.Text(lead, fw=500, fz="h5", ta="left", style=style_lead), span=1, style=style2),
